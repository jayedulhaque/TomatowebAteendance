...
<div class="content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{ __('messages.create_role_permission') }}
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-content">
                        <form action="{{route('role.store')}}" class="ui form grid" method="post" accept-charset="utf-8">
                           {{csrf_field()}}
                           <div class="two fields">
                           <div class="field">
                    <label>{{ __('messages.role_name') }}</label>
                    <input class="uppercase" name="role_name" value="" type="text" required="required">
                </div>
                ...
                <div class="field">
                    ...
                    <div class="ui dropdown uppercase selection notempty" tabindex="0">
                        <select name="state" required="required">
                                ...
                                @endforeach
                            </select><i class="dropdown icon"></i><div class="default text">{{ __('messages.select_status') }}</div><div class="menu transition hidden" tabindex="-1">
                                @foreach($statuses as $status)
                                ...
                                <div class="ui relaxed list">
                                    ...
                                    <div class="item">
                                        <div class="ui master checkbox">
                                            <input type="checkbox" name="perms[]" value="{{$permission->id}}" tabindex="0" class="notempty hidden">
                                                ...
                                                <div class="list">
                                                    ...
                                                    <div class="item">
                                                        <div class="ui child checkbox slider">
                                                            <input type="checkbox" name="perms[]" value="{{$perm->id}}" tabindex="0" class="notempty hidden">
                                    ...
                                    <h3 class="ui sub header">{{ __('messages.leave') }}</h3>
                                    <div class="item">
                                        <div class="ui master checkbox">
                                            <input type="checkbox"  tabindex="0" class="notempty hidden">
                                            <label>{{$permission->display_name}}</label>
