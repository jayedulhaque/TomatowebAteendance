...
<div class="content">
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title">{{ __('messages.employee_birthdays') }}
                {{-- <a href="http://demo-workday.herokuapp.com/export/report/birthdays" class="ui basic button mini offsettop5 btn-export float-right"><i class="ui icon download"></i>Export to CSV</a> --}}
            ...
            <div class="box box-success">
                <div class="box-body">
                    <div id="dataTables-example_wrapper" class="dataTables_wrapper dt-semanticUI no-footer"><div class="ui stackable grid"><div class="row"><div class="eight wide column"></div><div class="right aligned eight wide column"></div></div><div class="row dt-table"><div class="sixteen wide column"><table width="100%" class="table table-striped table-hover dataTable no-footer dtr-inline" id="dataTables-example" data-order="[[ 0, &quot;asc&quot; ]]" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                        <thead>
                            <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 327.5px;" aria-sort="ascending" aria-label="Employee Name: activate to sort column descending">{{ __('messages.employee_name') }}</th><th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 147.5px;" aria-label="Department: activate to sort column ascending">{{ __('messages.department') }}</th><th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 268.5px;" aria-label="Position: activate to sort column ascending">{{ __('messages.position') }}</th><th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 165.5px;" aria-label="Birthday: activate to sort column ascending">{{ __('messages.birthday') }}</th><th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 193.5px;" aria-label="Contact Number: activate to sort column ascending">{{ __('messages.contact_number') }}</th></tr>
                        </thead>
                        <tbody>
                        ...
                        <tr role="row" class="odd">
                                ...
                                {{$job->title}}</td>
                                        <td>
                                        {{date('d F Y', strtotime($user->dob))}}                                        </td>
